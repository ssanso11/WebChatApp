(function () {
  ...
  self.addEventListener('push', function (e) {
    ...
    var handleNotification = function handleNotification(payload) {
    ...
    sendNotificationDelivered(payload);
  ...
  function sendNotificationDelivered(payload) {
    var timestamp = event.timeStamp; // Do all browsers support this
  }
